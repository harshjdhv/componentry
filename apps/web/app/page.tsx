    ...
    <div className="min-h-svh flex flex-col relative">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20">
        <div className="max-w-3xl text-center space-y-8">
          ...
          <FadeIn delay={300} className="flex items-center justify-center gap-4 pt-4">
            <Link
              href="/docs"
              className="group inline-flex items-center gap-2 bg-foreground text-background px-6 py-3 rounded-full text-sm font-medium hover:opacity-90 transition-opacity"
            >
              Browse Components
              <svg 
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium border border-border hover:bg-accent transition-colors"
            >
          ...
          <FadeIn delay={400} className="flex items-center justify-center gap-6 pt-8 text-sm text-muted-foreground">
