...
interface DemoFrameProps extends React.HTMLAttributes<HTMLDivElement> {
    src: string
    title: string
}

export function DemoFrame({ src, title, className, ...props }: DemoFrameProps) {
            ...
            <motion.div
                ...
                className={cn(
                    ...
                    isFullscreen
                        ...
                        : cn("relative w-full aspect-video rounded-xl border", className)
                )}
                {...(props as any)}
            >
                <Button
