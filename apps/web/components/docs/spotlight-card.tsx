        ...
        <DocsPageLayout
            ...
            preview={
                <div className="flex items-center justify-center p-8 min-h-[400px]">
                    <SpotlightCard className="w-96 bg-black/90 border-0">
                        <SpotlightCardHeader>
                            <SpotlightCardTitle className="text-white">Spotlight Effect</SpotlightCardTitle>
                            <SpotlightCardDescription className="text-neutral-400">
                                Hover over this card to see the spotlight follow your cursor
                            </SpotlightCardDescription>
                        </SpotlightCardHeader>
                        <SpotlightCardContent>
            ...
            examples={[
                {
                    ...
                    preview: (
                        <div className="flex items-center justify-center p-8 min-h-[400px]">
                            <SpotlightCard
                                className="w-96 bg-black/90 border-0"
                                spotlightColor="rgba(255, 100, 100, 0.4)"
                                glowIntensity={0.2}
                                borderRadius={24}
                            >
                                <SpotlightCardHeader>
                                    <SpotlightCardTitle className="text-white">Custom Colors</SpotlightCardTitle>
                                    <SpotlightCardDescription className="text-neutral-400">
                                        Fully customizable spotlight color and intensity
                                    </SpotlightCardDescription>
                                </SpotlightCardHeader>
                ...
                },
                {
                    ...
                    preview: (
                        <div className="flex items-center justify-center p-8 min-h-[400px]">
                            <MultiSpotlightCard className="w-full max-w-lg mx-auto p-6 h-64 bg-black/90 border-neutral-800">
                                <h4 className="text-white font-medium mb-2">Multi Spotlight</h4>
                                <p className="text-neutral-400 text-sm">
                                    Multiple colored spotlight sources follow your cursor
                                </p>
                ...
                },
                {
                    ...
                    preview: (
                        <div className="flex items-center justify-center p-8 min-h-[400px]">
                            <BeamSpotlightCard className="w-full max-w-lg mx-auto p-6 h-64 bg-black/90 border-neutral-800">
                                <h4 className="text-white font-medium mb-2">Beam Spotlight</h4>
                                <p className="text-neutral-400 text-sm">
                                    Crossing light beams create a dramatic effect
                                </p>
                ...
                },
                {
                    ...
                    preview: (
                        <div className="flex items-center justify-center p-8 min-h-[400px]">
                            <GradientFollowCard className="w-full max-w-lg mx-auto p-6 h-64 bg-black/90 border-neutral-800">
                                <h4 className="text-white font-medium mb-2">Gradient Follow</h4>
                                <p className="text-neutral-400 text-sm">
                                    Dynamic gradient background follows cursor position
                                </p>
                    ...
                    code: gradientFollowCode,
                },
                {
                    title: "3D Tilt",
                    preview: (
                        <div className="flex items-center justify-center p-8 min-h-[400px]">
                            <TiltSpotlightCard className="w-full max-w-lg mx-auto p-6 h-64 bg-black/90 border-neutral-800">
                                <h4 className="text-white font-medium mb-2">3D Tilt</h4>
                                <p className="text-neutral-400 text-sm">
                                    Perspective tilt with glare effect for depth
                                </p>
