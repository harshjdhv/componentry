...
// These styles are static, so we extract them to avoid recreating on each render
const codeStyles = `
  .shiki {
    counter-reset: line;
  }
...
/**
 * Server Component CodeBlock with cached highlighting.
 * This is the FAST version that uses our singleton highlighter.
 */
