    ...
    return (
        <React.Fragment>
            ...
            {variant === "dual" ? (
                ...
                <div className={cn("overflow-hidden border-y border-white/10 bg-background relative", cnContainer)}>
                ...
                <div className={cn("flex flex-col overflow-hidden border-y border-white/10 bg-background relative", containerClassName)}>
